...
- Key CSV outputs supporting dataset roles, replication metrics, stable/unstable gene sets, pathway summaries, AUC decay, demographic/mapping audit, blood-cell marker-score sensitivity, and manuscript claim checks.
- Audit reports and R session information files.
